	...
	describe('Get PTN', () => {
		it('should return full PTN output', () => {
			const game1 = {
				...
				date: 1653488350594,
				size: 7,
				player_white: 'Covault',
				player_black: 'Catalyst',
				notation:
					'P A7,P D4,P E4,P A4,P D3,P B4,P D2,P D7,P D5,P D6,P D1,P C4 C,P E5,M C4 D4 1,P E6,P E7,P F6,P F7,P G7 C,M D4 E4 2,M G7 F7 1,M E7 E6 1,M F6 E6 1,M E4 E5 3,M E6 C6 1 2,P D4 C,P C7,P C4,P C5,P G4,P E4 C,P A5,P C3,M E5 D5 4,M C3 C4 1,M D5 C5 5,M C7 D7 1,M C5 C6 6,P E5,M C6 D6 7,M F7 E7 2,M D4 C4 1,P E3,M D6 E6 7,P D5',
				result: 'R-0',
				timertime: 180,
				timerinc: 20,
				rating_white: 1080,
				...
				pieces: 40,
				capstones: 2,
				rating_change_white: 164,
				rating_change_black: -66
			};
			const game2 = {
				id: 500121,
				date: 1461430700000,
